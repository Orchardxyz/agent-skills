...
```bash
npx skills add git@github.com:Orchardxyz/agent-skills.git/agent-skills/skills/[skill-name]
```

### Install all curated skills

```bash
npx skills add git@github.com:Orchardxyz/agent-skills.git/agent-skills
```
